...
jiraLogo = ''
...
if (len(inProgressIssues) == 0):
  ...
  addMenuItem('Can only have 1 issue in progress!')
...
addSeparator()
addMenuItem("Open JIRA", {'href': credentials["host"], 'image': jiraLogo})
